                ...
                <NavBar />
                    <div className="ProjectHome">
                       <div className="ProjectTileHolder">
                            <ProjectTile title="DSC Photography" id="PhotographyWebsite" link="https://delaneychlarsonphotography.netlify.app" image={Photography} description="A project using reactJS, CSS grid, React-Router, and various other tools."/> 
                            ...
                            <ProjectTile title="PoemFinder" id="PoemFinder" link="https://poemfinder.netlify.app/" image={PoemFinder} description="This was an app I developed in V school which navigates through the OpenPoemDB API"/> 
                            <ProjectTile title="Github" id="github" link="https://github.com/NoalTessman" image={github} description="MY github, coding collection for many years, everything I've done besides my ruby projects are on here."/> 
